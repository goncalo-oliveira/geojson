...
public sealed class GeoPolygon : GeoObject
{
    ...
    public GeoPolygon(IEnumerable<GeoPosition> positions): this([new GeoLinearRing(positions)], null, DefaultProperties)
    {
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(rings, nameof(rings));
